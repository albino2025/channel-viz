(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'Gr5aw0GOFcyEm4IsoAN0VDLJFeHYn9CBd8XOFtE6jxkOD5pC', // Unique master Xively API key to be used as a default
		defaultFeeds	= ['172663481!Chauffage_Buanderie,172663481!Chauffage_Buanderie'], // Comma separated array of Xively Feed ID numbers
		applicationName	= '', // Replaces Xively logo in the header
		dataDuration	= 'Albino\'s feeds', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
							...
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									var graph = new Rickshaw.Graph( {
										...
										width: 600,
										height: 200,
										renderer: 'scatterplot',//'bar', //'scatterplot', //line',
